...
<body>
    <div class="registration-form">
        <form action="{{route('register-proses')}}" method="POST">
            ...
            <div style="text-align: center;margin-bottom:20px;"><span style="font-size:40px;">Register</span></div>

            <div class="form-group">
                <input type="text" class="form-control item" name="name" placeholder="nama">
                @error('name')
                <p style="color: red">
                    {{ $message }}
                </p>
            ...
            <p>Have account?<a href="{{route('login')}}">Sign in</a>
            </p>
        </form>
